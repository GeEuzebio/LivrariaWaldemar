...
namespace LibraryApp.Controllers
{
    public class CardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,RegistrationNumber,Name,Email")] Card card)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RegistrationNumber,Name,Email")] Card card)
        {
            if (id != card.Id)
            {
                return NotFound();
